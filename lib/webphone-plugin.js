...
(function ($) {
  ...
  function isCallAnswered(remote_num){
    $("#calling-state").addClass("hidden");
    $(".webphone-elapse-time").removeClass('hidden')
    $("#call-active").removeClass('hidden')
    $("#call-mute").addClass('hidden')
    $("#switch-keypad").removeClass('hidden')
  }


  function _fSansayUiCallStateHandling(active, remote_num) {
    console.log(active, "active========");
    console.log(remote_num,"remote num");
